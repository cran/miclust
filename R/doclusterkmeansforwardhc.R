...
#'
#' \code{doclusterkmeansforwardhc} performs K-means clustering with forward
...
#' @noRd
doclusterkmeansforwardhc <- function(data, k, metriccent, inertiapower = 1,
                                     maxvars, centpos) {
  selectedset <- NULL
